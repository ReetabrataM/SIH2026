...
export async function migrate() {
  const statements = [
    ...
    `ALTER TABLE analysis_results ADD COLUMN IF NOT EXISTS sentiment TEXT NOT NULL DEFAULT 'neutral'`,
    `ALTER TABLE analysis_results ADD COLUMN IF NOT EXISTS emotion TEXT NOT NULL DEFAULT 'neutral'`,
    `ALTER TABLE analysis_results ADD COLUMN IF NOT EXISTS stance TEXT NOT NULL DEFAULT 'not_inferred'`,
    `ALTER TABLE analysis_results ADD COLUMN IF NOT EXISTS topics_json JSONB NOT NULL DEFAULT '[]'`,
